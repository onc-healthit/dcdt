...
public class Entry extends ToolBean
{
	...
	public static String getCertDerFilePath(String name, String path)
	{
		return getFilePath(name, path, CERT_SUFFIX, DER_EXT);
	}
	
	public static String getCertPemFilePath(String name, String path)
	{
		return getFilePath(name, path, CERT_SUFFIX, PEM_EXT);
	}
	
	public static String getKeyDerFilePath(String name, String path)
	{
		return getFilePath(name, path, KEY_SUFFIX, DER_EXT);
	}
	
	public static String getKeyPemFilePath(String name, String path)
	{
		return getFilePath(name, path, KEY_SUFFIX, PEM_EXT);
	}
	
	public static String getKeyStoreFilePath(String name, String path)
	{
		return getFilePath(name, path, PKCS12_EXT);
	}
	
	public static String getFilePath(String name, String path, String ... suffixes)
	{
	...
	{
		return getCertDerFilePath(this.name, this.path);
	}
	
	public String getCertPemFilePath()
	{
		return getCertPemFilePath(this.name, this.path);
	}
	
	public String getKeyDerFilePath()
	{
		return getKeyDerFilePath(this.name, this.path);
	}
	
	public String getKeyPemFilePath()
	{
		return getKeyPemFilePath(this.name, this.path);
	}
	
	public String getKeyStoreFilePath()
	{
		return getKeyStoreFilePath(this.name, this.path);
	}
