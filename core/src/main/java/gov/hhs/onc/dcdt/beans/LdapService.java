...
public class LdapService extends ToolBean
{
	...
	public void setBindDnName(String bindDnName) throws ToolLdapException
	{
	...
	public void setHashBindPassDigestName(String digestName) throws ToolLdapException
	{
		this.hashBindPassDigest = LdapSecurityConstants.getAlgorithm(digestName);
		
		if (this.hashBindPassDigest == null)
		{
			throw new ToolLdapException("Unknown LDAP hash digest algorithm: " + digestName);
		}
	}
	...
	private static Dn parseBindDn(String bindDnStr) throws ToolLdapException
	{
		try
		{
		...
		{
			throw new ToolLdapException("Unable to parse LDAP bind distinguished name: " + bindDnStr, e);
		}
	}
