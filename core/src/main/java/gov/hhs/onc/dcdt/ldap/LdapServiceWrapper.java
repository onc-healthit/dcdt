...
public class LdapServiceWrapper
{
	...
	public boolean add(Entry... entries) throws ToolLdapException
	{
		return this.add(Arrays.asList(entries));
	}
	
	public boolean add(Iterable<Entry> entries) throws ToolLdapException
	{
	...
	public boolean add(Entry entry) throws ToolLdapException
	{
		if (!this.isBound())
		{
			throw new ToolLdapException("LDAP service wrapper is not bound to LDAP service (" + this.service.toUrl() + ").");
		}
		...
		{
			throw new ToolLdapException("Unable to add entry to LDAP service (" + this.service.toUrl() + "): " + entry, e);
		}
	...
	public boolean modify(LdifEntry... ldifEntries) throws ToolLdapException
	{
		return this.modify(Arrays.asList(ldifEntries));
	}
	
	public boolean modify(Iterable<LdifEntry> ldifEntries) throws ToolLdapException
	{
		boolean modified = false;
	...
	public boolean modify(LdifEntry ldifEntry) throws ToolLdapException
	{
		if (!this.isBound())
		{
			throw new ToolLdapException("LDAP service wrapper is not bound to LDAP service (" + this.service.toUrl() + ").");
		...
		{
			throw new ToolLdapException("Unable to modify LDIF entry data in LDAP service (" + this.service.toUrl() + "): " + ldifEntry, e);
		}
	...
	public List<Dn> getBaseDns() throws ToolLdapException
	{
		if (!this.isBound())
		{
			throw new ToolLdapException("LDAP service wrapper is not bound to LDAP service (" + this.service.toUrl() + ").");
		...
		{
			throw new ToolLdapException("Unable to create base DN from naming contexts attribute: " + attr, e);
		}
	...
	public List<Entry> search(ExprNode filterNode, String ... attributes) throws ToolLdapException
	{
		return this.search(filterNode, SearchScope.ONELEVEL, attributes);
	}
	
	public List<Entry> search(ExprNode filterNode, SearchScope scope, String ... attributes) throws ToolLdapException
	{
		return this.search(new ArrayList<Dn>(), filterNode, scope, attributes);
	}
	
	public List<Entry> search(List<Dn> baseDns, ExprNode filterNode, SearchScope scope, String ... attributes) throws ToolLdapException
	{
	...
	public List<Entry> search(Dn baseDn, ExprNode filterNode, SearchScope scope, String ... attributes) throws ToolLdapException
	{
		if (!this.isBound())
		{
			throw new ToolLdapException("LDAP service wrapper is not bound to LDAP service (" + this.service.toUrl() + ").");
		...
		try
		{
			...
			{
				throw new ToolLdapException("LDAP service search (" + this.service.toUrl(baseDn, filter, scope, attributes) + 
		...
		{
			throw new ToolLdapException("Unable to search LDAP service: " + this.service.toUrl(baseDn, filter, scope, attributes), e);
		}
	...
	public boolean connect() throws ToolLdapException
	{
		if (this.isConnected())
		{
			this.disconnect();
		...
		{
			throw new ToolLdapException("Unable to connect to LDAP service (" + this.service + ").", e);
		}
	}
	
	public boolean bind() throws ToolLdapException
	{
		if (!this.isConnected())
		{
			this.connect();
		...
		{
			throw new ToolLdapException("Unable to bind" + (this.service.isAnonymousBind() ? " anonymously" : "") + " to LDAP service (" + 
	...
	public boolean unBind() throws ToolLdapException
	{
		if (!this.isBound())
		{
			return true;
		...
		{
			throw new ToolLdapException("Unable to unbind from LDAP service (" + this.service + ").", e);
		}
	}
	
	public boolean disconnect() throws ToolLdapException
	{
		if (!this.isConnected())
		{
			return true;
		...
		{
			throw new ToolLdapException("Unable to close connection to LDAP service (" + this.service + ").", e);
		}
	}
