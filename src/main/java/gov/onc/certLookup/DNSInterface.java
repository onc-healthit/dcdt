...
public class DNSInterface implements IDNSInterface {
	...
	/* (non-Javadoc)
	 * @see com.nitor.group.certLookup.IDNSInterface#sendQueryViaResolver(org.xbill.DNS.Message)
	 */
	...
	/* (non-Javadoc)
	 * @see com.nitor.group.certLookup.IDNSInterface#queryForSrvViaLookup(java.lang.String)
	 */
