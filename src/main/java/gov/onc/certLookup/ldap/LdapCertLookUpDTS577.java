...
public class LdapCertLookUpDTS577 implements CertLookUpFactory{
	...
	public CertificateInfo execute(CertificateInfo certInfo)
		...
		for(int i = 0; i<priorities.size(); i++){
			...
			if(userCert != null){
				certInfo.setResult("Failure: Certificate found at LDAP for " + certInfo.getOrigAddr());
				this.success = true;
				...
				System.out.println("Success: Unable to find certificate at LDAP for: " 
