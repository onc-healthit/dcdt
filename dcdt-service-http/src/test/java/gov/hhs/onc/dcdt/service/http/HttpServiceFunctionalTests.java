...
public class HttpServiceFunctionalTests extends AbstractToolServiceFunctionalTests<HttpTransportProtocol, HttpServerConfig, HttpServer, HttpService> {
                    ...
                    .assertTrue(
                        (discoveryTestcaseIssuerCredItemLookupResult =
                            lookupService.getUri((discoveryTestcaseIssuerCredItemUri =
                                new URI(HttpTransportProtocol.HTTP.getScheme(), null, serverHostAddr, serverPort, discoveryTestcaseIssuerCredCertPath, null,
                                    null)))).isSuccess(),
                        String
                            .format(
                                ...
                                (discoveryTestcaseCredName =
                                    (discoveryTestcaseCred = discoveryTestcaseCredItemPaths.get(discoveryTestcaseIssuerCredCertPath)).getName()),
                                serverHostAddr, serverPort, discoveryTestcaseIssuerCredItemUri,
                                StringUtils.join(discoveryTestcaseIssuerCredItemLookupResult.getMessages(), "; ")));
            ...
            for (String discoveryTestcaseIssuerCredCrlPath : (discoveryTestcaseCredItemPaths = server.getDiscoveryTestcaseIssuerCredentialCrlPaths()).keySet()) {
                Assert
                    .assertTrue(
                        (discoveryTestcaseIssuerCredItemLookupResult =
                            lookupService.getUri((discoveryTestcaseIssuerCredItemUri =
                                new URI(HttpTransportProtocol.HTTP.getScheme(), null, serverHostAddr, serverPort, discoveryTestcaseIssuerCredCrlPath, null,
                                    null)))).isSuccess(), String.format(
