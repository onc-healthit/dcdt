...
<html>
	<jsp:include page="/include/headerbootstrap.jsp" flush="true">
		...
		<jsp:param name="pgDesc" value="Direct Certificate Discovery Testing Tool - Home" />
		<jsp:param name="pgKey" value="Direct Certificate Discovery Testing Tool - Home Screen" />
	...
	<body>
		<div class="container">
			...
			<ul>
				<li><a href="dns.jsp">Hosting</a> allows a System Under Test (SUT) to verify that their certificates are hosted correctly, and discoverable by other Direct implementations.</li>
				<li><a href="download.jsp">Discovery</a> allows a SUT to verify that they can discover certificates in other Direct implementations by using them to send Direct messages.</li>
			</ul>
			<p>
