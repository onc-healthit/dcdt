...
{
	private final static String VERSION_PROP_NAME = "project.version";
	private final static String VERSION_SVN_AUTHOR_PROP_NAME = "project.version.svn.author";
	private final static String VERSION_SVN_DATE_PROP_NAME = "project.version.svn.date";
	private final static String VERSION_SVN_HEAD_URL_PROP_NAME = "project.version.svn.head.url";
	private final static String VERSION_SVN_REVISION_PROP_NAME = "project.version.svn.revision";
	...
	{
		return getValue(VERSION_PROP_NAME, VERSION_PATTERN);
	}
	
	public static String getSvnAuthor()
	{
		return getValue(VERSION_SVN_AUTHOR_PROP_NAME, VERSION_SVN_AUTHOR_PATTERN);
	}
	
	public static String getSvnDate()
	{
		String dateStr = getValue(VERSION_SVN_DATE_PROP_NAME, VERSION_SVN_DATE_PATTERN);
	...
	{
		return getValue(VERSION_SVN_HEAD_URL_PROP_NAME, VERSION_SVN_HEAD_URL_PATTERN);
	}
	
	public static String getSvnRevision()
	{
		return getValue(VERSION_SVN_REVISION_PROP_NAME, VERSION_SVN_REVISION_PATTERN);
	}
