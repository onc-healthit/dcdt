...
public class DnsLookupServiceFunctionalTest extends ToolTestNgFunctionalTests {
    ...
    public void testGetARecords() throws Exception {
        ARecord[] aRecords = dnsLookupService.getARecords(DEMO_DIRECT_TEST_DOMAIN);
    ...
    public void testGetMxRecords() throws Exception {
        MXRecord[] mxRecords = dnsLookupService.getMxRecords(DEMO_DIRECT_TEST_DOMAIN);
    ...
    public void testGetCertRecords() throws Exception {
        CERTRecord[] certRecords = dnsLookupService.getCertRecords(DIRECT1_DEMO_DIRECT_TEST_DOMAIN);
    ...
    public void testGetSoaRecords() throws Exception {
        SOARecord[] soaRecords = dnsLookupService.getSoaRecords(DEMO_DIRECT_TEST_DOMAIN);
    ...
    public void testGetSrvRecords() throws Exception {
        SRVRecord[] srvRecords = dnsLookupService.getSrvRecords(ServiceType.LDAP, Protocol.TCP, DIRECT1_DEMO_DIRECT_TEST_DOMAIN);
    ...
    public void testGetNsRecords() throws Exception {
        NSRecord[] nsRecords = dnsLookupService.getNsRecords(DEMO_DIRECT_TEST_DOMAIN);
