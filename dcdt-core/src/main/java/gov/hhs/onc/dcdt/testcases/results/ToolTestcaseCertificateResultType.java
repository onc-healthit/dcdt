...
public enum ToolTestcaseCertificateResultType {
    VALID_CERT("dcdt.testcase.result.cert.ValidCert.msg"), INCORRECT_CERT_TYPE("dcdt.testcase.result.cert.IncorrectCertType.msg"), MISSING_CERT_ATTR(
        ...
        "dcdt.testcase.result.cert.InvalidSubjAltName.msg"), NO_CERT("dcdt.testcase.result.cert.NoCert.msg"), INCORRECT_CERT(
        "dcdt.testcase.result.cert.IncorrectCert.msg"), MISSING_CERT("dcdt.testcase.result.cert.MissingCert.msg");
