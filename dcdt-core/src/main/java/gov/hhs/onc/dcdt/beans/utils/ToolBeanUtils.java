...
public abstract class ToolBeanUtils {
    public static class NamedBeanNamePredicate extends BeanPropertyValuePredicate<String> {
    ...
    public static <T extends ToolNamedBean> T findNamed(ListableBeanFactory beanFactory, String namedBeanName, Class<T> namedBeanClass) {
        return CollectionUtils.find(ToolBeanFactoryUtils.getBeansOfType(beanFactory, namedBeanClass), new NamedBeanNamePredicate(namedBeanName));
    }
