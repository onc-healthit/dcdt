...
public class KeyPairInfoImpl extends AbstractCryptographyDescriptor implements KeyPairInfo {
    ...
    public KeyPairInfoImpl(@Nullable PublicKey publicKey, @Nullable PrivateKey privateKey) {
        this(new KeyPair(publicKey, privateKey));
    }

    public KeyPairInfoImpl(@Nullable KeyPair keyPair) {
