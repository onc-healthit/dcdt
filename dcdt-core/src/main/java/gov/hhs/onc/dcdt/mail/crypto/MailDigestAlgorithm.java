...
public enum MailDigestAlgorithm implements CryptographyAlgorithmIdentifier {
    SHA1("SHA-1", OIWObjectIdentifiers.idSHA1, "sha1"), SHA256("SHA-256", NISTObjectIdentifiers.id_sha256, "sha256"), SHA384("SHA-384",
        NISTObjectIdentifiers.id_sha384, "sha384"), SHA512("SHA-512", NISTObjectIdentifiers.id_sha512, "sha512");
