...
public enum SmtpReplyCode implements ToolCodeIdentifier, ToolIdentifier {
    ...
    AUTH_TEMP_ERROR(454), PARAMETER_ERROR(455), SYNTAX_ERROR_COMMAND_UNRECOGNIZED(500), SYNTAX_ERROR_ARGUMENTS(501), COMMAND_UNIMPLEMENTED(502), BAD_SEQUENCE(
        503), PARAMETER_UNIMPLEMENTED(504), AUTH_REQUIRED(530), AUTH_FAILED(535), AUTH_MECHANISM_WEAK(534), AUTH_ENCRYPTION_REQUIRED(538),
    MAILBOX_PERM_UNAVAILABLE(550), USER_NOT_LOCAL(551), SYSTEM_STORAGE_EXCEEDED(552), SYNTAX_ERROR_MAILBOX(553), TRANSACTION_FAILED(554),
    MAIL_PARAMETERS_UNIMPLEMENTED(555);
