...
public abstract class ToolMailContentTypeUtils {
    ...
    public static boolean isMultipartSignature(MimeType contentType) {
        return (ToolMimeTypeUtils.equals(false, contentType, MailContentTypes.MULTIPART_SIGNED_PROTOCOL_PKCS7_SIG,
    ...
    public static boolean isDetachedSignature(MimeType contentType) {
        return ToolMimeTypeUtils.equals(false, contentType, MailContentTypes.APP_PKCS7_SIG, MailContentTypes.APP_X_PKCS7_SIG);
    }

    public static boolean isSignedData(MimeType contentType) {
        return ToolMimeTypeUtils.equals(false, contentType, MailContentTypes.APP_PKCS7_MIME_SIGNED, MailContentTypes.APP_X_PKCS7_MIME_SIGNED);
    }

    public static boolean isEnvelopedData(MimeType contentType) {
        return ToolMimeTypeUtils.equals(false, contentType, MailContentTypes.APP_PKCS7_MIME_ENV, MailContentTypes.APP_X_PKCS7_MIME_ENV);
    }
}
