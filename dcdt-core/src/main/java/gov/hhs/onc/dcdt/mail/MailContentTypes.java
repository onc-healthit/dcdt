...
public final class MailContentTypes {
    ...
    public final static MimeType APP_PKCS7_MIME_ENV = ToolMimeTypeUtils.valueOf(CoreContentTypes.APP_TYPE, CryptographyContentTypes.APP_PKCS7_MIME_SUBTYPE,
        SMIME_TYPE_ENV_DATA_PARAM, NAME_SMIME_MIME_PARAM);
    public final static MimeType APP_PKCS7_MIME_SIGNED = ToolMimeTypeUtils.valueOf(CoreContentTypes.APP_TYPE, CryptographyContentTypes.APP_PKCS7_MIME_SUBTYPE,
        SMIME_TYPE_SIGNED_DATA_PARAM);

    public final static MimeType APP_X_PKCS7_MIME_ENV = ToolMimeTypeUtils.valueOf(CoreContentTypes.APP_TYPE, CryptographyContentTypes.APP_X_PKCS7_MIME_SUBTYPE,
        SMIME_TYPE_ENV_DATA_PARAM, NAME_SMIME_MIME_PARAM);
    public final static MimeType APP_X_PKCS7_MIME_SIGNED = ToolMimeTypeUtils.valueOf(CoreContentTypes.APP_TYPE,
        CryptographyContentTypes.APP_X_PKCS7_MIME_SUBTYPE, SMIME_TYPE_SIGNED_DATA_PARAM);

    public final static MimeType APP_PKCS7_SIG = ToolMimeTypeUtils.valueOf(CoreContentTypes.APP_TYPE, CryptographyContentTypes.APP_PKCS7_SIG_SUBTYPE,
        NAME_SMIME_SIG_PARAM);

    public final static MimeType APP_X_PKCS7_SIG = ToolMimeTypeUtils.valueOf(CoreContentTypes.APP_TYPE, CryptographyContentTypes.APP_X_PKCS7_SIG_SUBTYPE,
        NAME_SMIME_SIG_PARAM);
    ...
    public final static String MULTIPART_SIGNED_PROTOCOL_PKCS7_SIG_PARAM_VALUE = ToolStringUtils.quote(CryptographyContentTypes.APP_PKCS7_SIG_BASETYPE);
    public final static String MULTIPART_SIGNED_PROTOCOL_X_PKCS7_SIG_PARAM_VALUE = ToolStringUtils.quote(CryptographyContentTypes.APP_X_PKCS7_SIG_BASETYPE);
